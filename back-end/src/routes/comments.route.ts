...
commentsRoute.patch(routeName,AuthTokenCheck,schemaValidationMiddleware(commentsUpdateSchema),commentsUpdateController)
commentsRoute.delete(routeName,AuthTokenCheck,commentsDeleteController)
