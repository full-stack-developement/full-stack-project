...
export class initialMigrations1677509573348 implements MigrationInterface {
    name = 'initialMigrations1677509573348'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "vehicle_comments" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "content" character varying NOT NULL, "vehicleId" uuid, "userId" uuid, CONSTRAINT "PK_dec9d23c4b2b2e8ecb3e25de01f" PRIMARY KEY ("id"))`);
