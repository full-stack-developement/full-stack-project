...
type typeVariants = "title-content-form" | "label-content-form" | "errors-form" | "text-delete" | "title-card" | "info-card" | "profile-description" | "car-description" | "date-comment"// tipe suas variantes aqui
